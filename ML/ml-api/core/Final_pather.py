...
# --------------------- OLLAMA COMMUNICATION (ONLINE MAS) ---------------------
def call_ollama(model, prompt, temperature=0.3):
  """
  Call a local Ollama server to get agent reasoning.

  Requirements:
    - Ollama running on http://localhost:11434
    - The specified `model` available (e.g. "llama3", "gpt-oss:120b-cloud")
  """
  ...
  try:
      ...
      # If MAS fails, log and fall back to "no extra coords" so the planner still works
